...
interpol=RectBivariateSpline(xlist, ylist, t_z) #used pretty much everytime we need the height of a specific point. Implemented in fortran and very fast. If we want smoothing we can use s=500 or similar
...
#p11=getCa([-2,0], direction=pi/2.-alpha, origin=p1,fromLocalCart=True)
#p12=getCa([2,0], direction=pi/2.-alpha, origin=p1,fromLocalCart=True)
#print p11, p12
